...
?>
    ...
    <div class="intro-text" style="background: rgb(33,37,41);">
        <div class="container">
            <h1 class="text-start">Page 5</h1>
            <div class="row">
                <div class="col content-right">
                    <nav>
                        <ul class="pagination">
                            <li class="page-item" target="_parent"><a class="page-link" href="film-4.php" aria-label="Previous"><span aria-hidden="true">«</span></a></li>
							...
							<li class="page-item active"><a class="page-link" href="film-5.php">5</a></li>
                            <li class="page-item disabled" target="_top"><a class="page-link" href="#" aria-label="Next"><span aria-hidden="true">»</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
            <?php
                $result = pg_query($db,"SELECT * FROM film ORDER BY release_date DESC LIMIT 10 OFFSET 40;");
